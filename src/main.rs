...
use clap::Parser;
use remote_config::{
    build_router, Config, ExchangeRateService, RiskCheckerService, WalletConfigService,
};
...
async fn main() -> Result<()> {
    ...
    let risk_checker_service = Arc::new(RiskCheckerService::new(&config.risk_checker));
